...
class LocaleConfig : WebMvcConfigurer {
    ...
    fun messageSource(): MessageSource =
        ResourceBundleMessageSource().apply {
            setBasename("messages")                    // busca messages.properties, messages_es.properties, etc.
            setDefaultEncoding("UTF-8")                // codificación para caracteres especiales (ñ, á, etc.)
            setFallbackToSystemLocale(false)           // no usar locale del sistema si no encuentra el archivo
        }
